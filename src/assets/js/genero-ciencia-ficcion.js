...
const articulosFiltrados = compose (filtrarPorTipo, filtrarPorGenero)('ciencia ficcion');

console.log(`Total peliculas de Ciencia Ficcion ${articulosFiltrados.length}`);
